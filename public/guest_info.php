                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <label style="color: black" class="col-md-12"></label>
                                <div class="col-md-12">
                                    <button  rel="tooltip" onClick='add()' class="btn-light" style="width: 30vh ;height: 5vh">WE HAVE A NEW GUEST
                                    </button>
                                    <a href=""  class="  " ></a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $sql5 = "select * from guest order by attendance DESC;";
                                ...
                                while ($result5=mysqli_fetch_assoc($records)) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <td>" . $result5['mobile'] . "</td>
                                        <td>" . $result5['branch'] . "</td>
                                        <td>" . $result5['semester'] . "</td>
                                        <td>" . $result5['attendance'] . "</td>
                                        <td><button  id='".$id1."' onClick ='update_g(this.id)' type=\"button\" rel=\"tooltip\" class=\"btn btn-info btn-icon btn-sm \">
...
<script type ="text/javascript">
    ...
    function update_g(clicked_id) {
        window.location.href = ("../function/up_guest.php?id="+clicked_id);
    }
    function add() {
    ...
    function delete1(clicked_id) {
        if (window.confirm('Do you want to delete?')){
                window.location.href = ("../function/del_guest.php?id="+clicked_id);
            } else {
                die();
            }
