                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button  rel="tooltip" onClick='add()' class="btn btn-danger btn-icon btn-sm" style="width: 12vh">New Meet
                            </button>
                            <!--Button to open a camera-->
                            <div class="icon icon-info">
                                <button  rel="tooltip" onClick='camera()' class="btn btn-info btn-icon btn-sm " style="width: 8vh ; height: 5vh">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $as="SELECT a.usn, m.name,a.percentage,a.count,a.d_count FROM login m, attendance a where a.usn=m.usn";
                        ...
                        <div class="card-footer ">
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="../function/del_file.php" class="btn-fill btn-outline-dark btn-round"> Clear Cache </a>
                                    <p style="padding-top: 20px; color: red">Kindly Clear the cache once a month </p>
                                </div>
                            </div>
                        </div>
                    </div>
