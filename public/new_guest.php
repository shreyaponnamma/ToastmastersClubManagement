...
<div class="wrapper wrapper-full-page ">
    <div class="full-page login-page section-image" filter-color="black" data-image="../upload/background.jpg">
        <div class="content">
            <div class="container">
                <div class="col-md-6 ml-auto mr-auto">
                    <form id="RegisterValidation" action="../function/guest.php" method="post">
                        <div class="card  bg-transparent">
                            <div class="card-header ">
                                <h3 style="color: #ccffff">Hurray!! We Have a New Guest</h3>
                            </div>
                            <div class="card-body ">
                                <div class="form-group has-label">
                                    <label style="color: #ccffff">
                                        Name *
                                    </label>
                                ...
                                <div class="form-group has-label">
                                    ...
                                    <input class="form-control" name="mob"  type="text"  required pattern="[0-9]{10}"/>
                                </div>
                                <div class="form-group has-label">
                                    <label style="color:#ccffff">
                                        Branch *
                                    </label>
                                    <input class="form-control" name="branch" id="registerPasswordConfirmation" type="text" required="true"/>
                                </div>
                                <div class="form-group has-label">
                                    <label style="color: #ccffff">
                                        Semester *
                                    </label>
                                    <input class="form-control" name="sem"  type="number" required="true"/>
                                </div>
                            </div>
