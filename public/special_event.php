                        ...
                        <div class="card-body ">
                            <form class="form-horizontal" method="post"action="../function/newspecial.php">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" type="number" class="form-control" name="mno" required pattern="[0-9]+">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Event</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" type="text" class="form-control" name="event" required pattern="[A-Za-z\s]+">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Chair</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" type="text" class="form-control" name="chair" required pattern="[A-Za-z\s]+">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Co-Chair</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" type="text" class="form-control" name="co-chair" required pattern="[A-Za-z\s]+">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer text-center">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <button type="submit" class="btn-fill btn-outline-dark btn-round">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script type ="text/javascript">
    ...
    function delete1(clicked_id) {
        if (window.confirm('Do you want to delete?')){
            window.location.href = ("../function/del_event.php?id="+clicked_id);
        } else {
            die();
        }
