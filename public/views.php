        ...
        <div class="content">
            <div class="container">
                <div class="col-md-8 ml-auto mr-auto">
                    <form id="RegisterValidation" action="../function/add_view.php" method="post">
                        <div class="card bg-transparent">
                            <div class="card-header ">
                                <h4 class="card-title" style="color: #ccffff">Please Share your views</h4>
                            </div>
                            <div class="card-body ">
                                ...
                                <div class="form-group has-label">
                                    ...
                                    <input class="form-control" name="view" id="registerPasswordConfirmation" type="text" required="true"/>
                                </div>
