                        ...
                        <div class="card-body ">
                            <form class="form-horizontal" action="../function/newregis.php" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input name="usn" type="text" class="form-control" pattern="[0-9]+" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input name="name" type="text" class="form-control" required pattern="[A-Za-z\s]+">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input name="role" type="text" class="form-control" required pattern="[user|admin]+">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-md-3 col-form-label">Member_id</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input name="year" type="text" class="form-control" required pattern="[0-9]{4}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input name="gen" type="text" class="form-control" required pattern="[m|f]">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input name="desig" type="text" class="form-control" required pattern="[A-Za-z\s]+">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input name="level" type="text" class="form-control" required pattern="[L&0-9]+">
                                        </div>
                                    </div>
                                </div>
