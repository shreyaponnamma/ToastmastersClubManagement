            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card " style="background-color:   #cce0ff">
                        ...
                        <div class="card-body ">
                            <form class="form-horizontal" action="../function/newregis.php" method="POST">
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Usn</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" name="usn" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label" >Name</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" name="name" type="text" class="form-control" required pattern="[A-Za-z\s]+">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Email</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" name="email" type="email" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Password</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" name="pass" type="password" class="form-control" required>
                                        </div>
                                    </div>
                                </div>

                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Member_id</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" name="mid" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Year</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" name="year" type="text" class="form-control" required pattern="[0-9]{4}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Dob</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" name="dob" type="date" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <label style="color: black" class="col-md-3 col-form-label">Gender</label>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" name="gen" type="text" class="form-control" required pattern="[male|female|Male|Female]">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input style="background-color: white" name="level" type="text" class="form-control" required pattern="[L&0-9]+">
                                        </div>
                                    </div>
                                </div>
