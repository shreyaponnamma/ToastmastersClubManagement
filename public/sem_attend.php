        ...
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <p style="color: red">Kindly delete the columns to adjust space</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="card ">
                        <div class="card-header ">
                            ...
                            <p style="color: blue">format: odd/even_year</p>
                        </div>
                        <div class="card-body ">
                ...
                <div class="col-md-5">
                    <div class="card ">
                        <div class="card-header ">
                            <h4 class="card-title">Delete Column</h4>
                            <p style="color: red"><i>please enter the colunm name appropriate</i></p>
                        </div>
                        <div class="card-body ">
                            <form class="form-horizontal" action="../function/del_month.php" method="POST">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="month" >
                                </div>
