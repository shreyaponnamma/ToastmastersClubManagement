                            ...
                            <div class="col-md-3">
                                <div class="statistics">
                                    <div class="info">
                                        ...
                                        <h3 class="info-title"><?php
                                            $mem = "Select count(*) as memct from members";
                                            $memres = $connect->query($mem);
                                            $memrow = $memres->fetch_assoc();
                                            echo $memrow['memct'];
                                            ?>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="statistics">
                                    <div class="info">
                                        ...
                                        <h3 class="info-title">
                                            <?php
                                            $mee = "Select count(*) as meect from meeting";
                                            $meeres = $connect->query($mee);
                                            $meerow = $meeres->fetch_assoc();
                                            echo $meerow['meect'];
                                            ?></h3>
                                        <h6 class="stats-title">Meetings</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="statistics">
                                    <div class="info">
                                        ...
                                        <!--Display Sppech count-->
                                        <h3 class="info-title"><?php
                                            $s = "Select count(*) as s from speech";
                                            $sres = $connect->query($s);
                                            $srow = $sres->fetch_assoc();
                                            echo $srow['s'];
                                            ?></h3>
                                        <h6 class="stats-title">Speeches</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="statistics">
                                    <div class="info">
                                        ...
                                        <!--Display Special Event count-->
                                        <h3 class="info-title"><?php
                                            $sp = "Select count(*) as spct from special_events";
                                            $spres = $connect->query($sp);
                                            $sprow = $spres->fetch_assoc();
                                            echo $sprow['spct'];
                                            ?></h3>
                                        <h6 class="stats-title">Special events</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                          <div class="table-responsive">
                              ...
                              $sql3 = "SELECT m.usn,m.name,m.level, (SELECT Count(*)AS ct from speech WHERE usn = m.usn)AS ct from members m";
